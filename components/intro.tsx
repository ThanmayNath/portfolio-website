...
import Thanmay from "@/public/Thanmay.jpg";
...
export default function Intro() {
  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className=" rounded-full h-36 w-36 object-cover border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
        </div>
      </div>
      ...
      >
        <span className="font-bold">Hello👋 I'm Thanmay,</span> a{" "}
        <span className="font-bold">results-driven Software Engineer, </span>{" "}
        <span className="font-bold">
          currently focused on honing my skills in building high-performance
          software and optimizing systems.
        </span>
      </motion.h1>
      ...
      >
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-4 px-4 text-lg font-medium">
          <Link
            href="#contact"
        ...
        <div className="flex flex-row sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium">
          <a
            ...
            href="https://www.linkedin.com/in/thanmay-nath/"
            target="_blank"
          >
            <BsLinkedin />
          </a>
          ...
          <a
            ...
            href="https://github.com/ThanmayNath"
            target="_blank"
          >
            <BsGithub />
          </a>
          ...
          <a
            className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
            href="https://www.instagram.com/thanmay_nath/"
            target="_blank"
          >
            <BsInstagram />
          </a>
